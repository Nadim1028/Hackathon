...
public class ServeClient extends Thread
{
    ...
    public void run()
    {
        try
        {
            ...
            String receivingTheData = (String) objectInputStream.readObject();


            String[] data = receivingTheData.split("\\?");
            ...
            if(command.equals("createAccount"))
            {
                ...
                String sendingTheData = "" + delimiter + "" + delimiter  + command + delimiter + isCreated;
            ...
            else if(command.equals("login"))
            {
                ...
                String sendingTheData = "" + delimiter + "" + delimiter  + command + delimiter + isLogin;
            ...
            else if(command.equals("initializeUserInfo"))
            {
                ...
                for(File f: files)
                {
                    if(f.getName().equals(user))
                    {
                        ...
                        String delimiter = "?";
                        String sendingTheData = "" + delimiter + user + delimiter  + command + delimiter + tmpUser.getName() + delimiter + tmpUser.getAccountNumber() + delimiter + tmpUser.getBalance();

                        ObjectOutputStream objectOutputStream = new ObjectOutputStream(client.getOutputStream());
                        objectOutputStream.writeObject(sendingTheData);
            ...
            else if(command.equals("deposit"))
            {
                ...
                String delimiter = "?";
                String sendingTheData = "" + delimiter + user + delimiter  + command + delimiter + isDeposit;
            ...
            else if(command.equals("transferBalance"))
            {
                ...
                String delimiter = "?";
                String sendingTheData = "" + delimiter + from + delimiter  + command + delimiter + isTransfer;
